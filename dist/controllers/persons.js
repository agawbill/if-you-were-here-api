...
var _persons = require("../services/persons.js");

var _Person = _interopRequireDefault(require("../models/Person.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const personsServiceInstance = new _persons.PersonsServices(_Person.default);
const personsController = {
  ...
  async byPosition(req, res, next) {
    try {
      ...
      const person = await personsServiceInstance.findPersonByPosition(position);
      res.status(200).json({
        success: true,
        data: person
      });
